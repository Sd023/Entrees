...
object DataMembers {
     ...
     const val tbl_masterUserCols = "uid,email,userId,role,hotel,hotelBranch,createdDate,hotelId,hotelBranchId"
...
*/
     ...
     const val tbl_locationMaster = "LocationMaster"
     const val tbl_locationMasterCols = "hotelId,hotelBranchId,lat,lng"
